...
I have to go to \ilname{http://$domain/cpanel}, login, click SSL/TLS, click Manage SSL sites, select my domain, and then copy/paste the \ilfile{cert.pem} and \ilfile{privkey.pem} files into the Certificate and Private Key fields.
